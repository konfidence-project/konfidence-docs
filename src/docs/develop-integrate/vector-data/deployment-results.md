...
Only Kubernetes Services can be exposed this way today. For how the deployer turns the annotation into a deployment result, see [Expose a Service as a deployment result](../../deploy-operate/install/deployer/kubernetes.md#expose-a-service-as-a-deployment-result).
