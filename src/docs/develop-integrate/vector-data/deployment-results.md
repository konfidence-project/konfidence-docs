...
Only Kubernetes Services can be exposed this way today. For how the deployer turns the annotation into a deployment result, see [Kubernetes Deployer — Exposing a Service as a deployment result](../../deploy-operate/deployer/overview.md#exposing-a-service-as-a-deployment-result).
