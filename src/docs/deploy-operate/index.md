...
2. [Manage deployers](./deployer/overview.md) explains deployment classes. The [Kubernetes deployer](./deployer/kubernetes.md) page installs the one deployer of the current release.
